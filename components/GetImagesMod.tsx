...
import { getFirestore,collection, query, orderBy, QuerySnapshot, onSnapshot, limit, connectFirestoreEmulator } from "firebase/firestore";
...
export const fetchImage=(
  ...
  try{
    ...
    const photoQuery = query(photoRef, orderBy("timeCreated","desc"), limit(2));
    // 更新をサブスクライブする
